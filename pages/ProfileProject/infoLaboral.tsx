...
export default function working_information() {
  const [mostrarElementosProteccion, setMostrarElementosProteccion] =
    useState(false);
  const [mostrarMaquinasHerramientas, setMostrarMaquinasHerramientas] =
    useState(false);
        ...
        <div className='mt-5'>
          <form action=''>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4'>
              {' '}
              {/* Used grid for better alignment */}
              <div>
              ...
              <div>
                <label htmlFor='cargoActual'>
                  Cargo actual <span className=' text-blue-500 '>*</span>{' '}
                </label>
                <input
                  type='text'
                  id='cargoActual'
              ...
              <div>
                <label htmlFor='salario'>
                  Salario <span className=' text-blue-500 '>*</span>{' '}
                </label>
                <input
                  type='number'
                  step='0.01'
              ...
              <div>
                <label htmlFor='tipoContrato'>
                  Tipo de contrato <span className=' text-blue-500 '>*</span>{' '}
                </label>
                <select
                  id='tipoContrato'
                  className='w-full p-2 border border-black rounded-lg'
              ...
              <div>
                <label>
                  Auxilio de alquiler computador personal para el trabajo{' '}
                  <span className=' text-blue-500 '>*</span>{' '}
                </label>
                <div className='flex space-x-2'>
                  <span>Si</span>
                  <input type='radio' id='Si' name='alqPc' value='Si' />
                  <span>No</span>
                  <input type='radio' id='No' name='alqPc' value='No' />
                </div>
              </div>
              ...
              <div>
                ...
                <div className='flex space-x-2'>
                  <span>Si</span>
                  <input type='radio' id='Si' name='auxilioCo' value='Si' />
                  <span>No</span>
                  <input type='radio' id='No' name='auxilioCo' value='No' />
                </div>
              </div>
              <div>
                <label htmlFor=''>
                  Afiliacion a poliza de salud corporativa{' '}
                  <span className=' text-blue-500 '>*</span>{' '}
                </label>
                <div className='flex space-x-2'>
                  <span>Si</span>
                  <input type='radio' id='Si' name='afisalud' value='Si' />
                  <span>No</span>
                  <input type='radio' id='No' name='afisalud' value='No' />
                  <span>Na</span>
                  <input type='radio' id='Na' name='afisalud' value='Na' />
                </div>
              </div>
            </div>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-5'>
              <div>
                <label htmlFor='maquinasHerramientas'>
                ...
                <div className='flex space-x-2'>
                  ...
                  <input
                    ...
                    name='Maquinas'
                    value='Si'
                    onClick={toggleMaquinasHerramientas}
                  />
                  <span>No</span>
                  <input type='radio' id='No' name='Maquinas' value='No' />
                </div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className='flex space-x-2'>
                  ...
                  <input
                    ...
                    name='elementosPp'
                    value='Si'
                    onClick={toggleElementosProteccion}
                  />
                  <span>No</span>
                  <input type='radio' id='No' name='elementosPp' value='No' />
                </div>
              </div>
