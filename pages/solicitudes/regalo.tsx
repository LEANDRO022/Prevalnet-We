      ...
      <form action="" >
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
          <div className='flex items-center gap-4'>
            <Icon icon="mdi:medal-outline" className='text-7xl text-gray-600' /><p className='text-xl font-semibold'>Medio dia libre por cumpleaños</p>
          </div>
          <div></div>
          ...
          <div className='gap-4 lg:w-9/12'>
            <label htmlFor="" className="block font-bold">Fecha<span className=' text-blue-500 '>*</span></label>
