...
const vacaciones = () => (
  <div className='container mx-auto mt-8 p-8 font-bold'>
    ...
    <form action="" >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-5">
        ...
        <div className='w-9/12'>
          <label htmlFor="" className="block font-bold">Aprobadores<span className=' text-blue-500 '>*</span></label>
          <input type="text" className="border border-black p-2 w-full rounded" placeholder='escriba aca los destinatarios' />
        </div>
        <div />
        <div className='w-9/12'>
          <label htmlFor="" className="block font-bold">Fecha de inicio de tu solicitud de vacaciones<span className=' text-blue-500 '>*</span></label>
          <input type="date" className="border border-black p-2 w-full rounded" />
        </div>
        <div className='w-9/12'>
          <label htmlFor="" className="block font-bold">Fecha de terminación de tu solicitud de vacaciones<span className=' text-blue-500 '>*</span></label>
          <input type="date" className="border border-black p-2 w-full rounded" />
        </div>
